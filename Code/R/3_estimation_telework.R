...
#manual$teleworkable <- as.numeric(manual$teleworkable)

##onet estimation
#teleworkable jobs: 
onetnoc$telework_q <- onetnoc$employment*onetnoc$teleworkable
#telworkable income:
onetnoc$telework_p <- (onetnoc$employment*onetnoc$mean.income)*onetnoc$teleworkable

##manual estimation
#teleworkable jobs: 
manual$telework_q <- manual$employment*manual$teleworkable
#telworkable income:
manual$telework_p <- (manual$employment*manual$mean.income)*manual$teleworkable
...
#save file
write.csv(geo_estimates, file = "./Data/Output/telework_estimates.csv")
